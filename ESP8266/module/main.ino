...
<html lang='en'>
  ...
  <body>
    <div class='container'>
      ...
      <p>Click to turn:</p>
      <div class='buttons'>
        <button type='button' class='button button33' id='buttonGreen' onclick='sendGPIO(5)'>GREEN ON</button>
        <button type='button' class='button button33' id='buttonRed' onclick='sendGPIO(4)'>RED ON</button>
        <button type='button' class='button button33' id='buttonYellow' onclick='sendGPIO(14)'>YELLOW ON</button>
        <button type='button' class='button button100' id='buttonOff' onclick='sendGPIO(0)'>ALL OFF</button>
      </div>
      <hr>
      <table>
        <thead>
      ...
      <hr>
      <svg id='diode' enable-background='new 0 0 65 250' height='251' i:pageBounds='0 65 250 0' i:rulerOrigin='0 0' overflow='visible' space='preserve' viewBox='0 0 65 250' width='65' xmlns='http://www.w3.org/2000/svg' xmlns:a='http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/' xmlns:graph='http://ns.adobe.com/Graphs/1.0/' xmlns:i='http://ns.adobe.com/AdobeIllustrator/10.0/' xmlns:x='http://ns.adobe.com/Extensibility/1.0/' xmlns:xlink='http://www.w3.org/1999/xlink'>
        <g i:dimmedPercent='50' i:layer='yes' i:rgbTrio='#4F008000FFFF' id='Layer_1'>
          ...
          <path id='svgC0' clip-rule='evenodd' d='M7.812,86.94V24.48c0-0.072,0-0.144,0-0.252    c0-12.42,10.08-22.5,22.5-22.5c12.384,0,22.392,9.864,22.536,22.248L52.812,86.94H7.812z' style='fill:#999999' fill-rule='evenodd' i:knockout='Off'/>
    ...
    <script>
      ...
      readDeviceName();
      refresh();
      setInterval(function () { refresh(); }, 10 * 1000);
    </script>
  </body>
</html>
)=====";
